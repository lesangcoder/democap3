  ...
  return (
    <div>
      ...
      <h1 className="mb-5 text-3xl font-medium uppercase">
        <span className="font-semibold text-blue-500">Login Account</span>
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="mb-6">
          ...
          <Input
            type="text"
            id="taiKhoan"
            className="bg-gray-50 border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500"
