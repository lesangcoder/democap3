  ...
  return (
    <div className="text-black">
      <h1 className="mb-10 text-3xl font-medium uppercase">
        <span className="font-semibold text-blue-500">Create Account </span>
        ...
        <div className="grid md:grid-cols-2 md:grid-rows-3 gap-6 mb-10 grid-cols-1 grid-rows-6">
          <div>
            ...
            <Input
              type="text"
              id="hoTen"
              className="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500"
